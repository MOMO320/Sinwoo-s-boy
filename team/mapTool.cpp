...
void mapTool::setUp()
{
	...
	addLeft = CreateWindow("button", "←", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, areaStartX + areaSizeX - 400, areaStartY + areaSizeY +30, 20, 30, _hWnd, HMENU(BTN_ADD_LEFT), _hInstance, NULL);
	addTop = CreateWindow("button", "↑", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, areaStartX + areaSizeX - 400 +25, areaStartY + areaSizeY + 30, 20, 30, _hWnd, HMENU(BTN_ADD_TOP), _hInstance, NULL);
	addRight = CreateWindow("button", "→", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, areaStartX + areaSizeX - 400 + 50, areaStartY + areaSizeY + 30, 20, 30, _hWnd, HMENU(BTN_ADD_RIGHT), _hInstance, NULL);
	addBottom = CreateWindow("button", "↓", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, areaStartX + areaSizeX - 400 + 75, areaStartY + areaSizeY + 30, 20, 30, _hWnd, HMENU(BTN_ADD_BOTTOM), _hInstance, NULL);
