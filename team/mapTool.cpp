...
void mapTool::setUp()
{
	...
	addLeft = CreateWindow("button", "←", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, areaStartX + areaSizeX - 400, areaStartY - 40, 20, 30, _hWnd, HMENU(BTN_ADD_LEFT), _hInstance, NULL);
	addTop = CreateWindow("button", "↑", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, areaStartX + areaSizeX - 400 +25, areaStartY - 40, 20, 30, _hWnd, HMENU(BTN_ADD_TOP), _hInstance, NULL);
	addRight = CreateWindow("button", "→", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, areaStartX + areaSizeX - 400 + 50, areaStartY - 40, 20, 30, _hWnd, HMENU(BTN_ADD_RIGHT), _hInstance, NULL);
	addBottom = CreateWindow("button", "↓", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, areaStartX + areaSizeX - 400 + 75, areaStartY - 40, 20, 30, _hWnd, HMENU(BTN_ADD_BOTTOM), _hInstance, NULL);
