...
void mainSwitch::soundSetting()
{
	...
	SOUNDMANAGER->addSound("08.kakariko village", "sound/08.kakariko village.wav", false, false);
	SOUNDMANAGER->addSound("09.dark world", "sound/09.dark world.wav", false, false);
	SOUNDMANAGER->addSound("10.battle with ganon", "sound/09.dark world.wav", false, false);
